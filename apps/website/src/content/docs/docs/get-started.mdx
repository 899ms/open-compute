...
<Tabs syncKey="package-manager">
  <TabItem label="npm">
    <Code
      code={`npm init -y\nnpm install --save-dev wrangler@4.127.1 @cloudflare/workers-types@5.20260830.1`}
      lang="sh"
    />
  </TabItem>
  <TabItem label="pnpm">
    <Code
      code={`pnpm init\npnpm add --save-dev wrangler@4.127.1 @cloudflare/workers-types@5.20260830.1`}
      lang="sh"
    />
  </TabItem>
  <TabItem label="bun">
    <Code
      code={`bun init -y\nbun add --dev wrangler@4.127.1 @cloudflare/workers-types@5.20260830.1`}
      lang="sh"
    />
  </TabItem>
</Tabs>
