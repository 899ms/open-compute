...
Supported Worker API behavior is tracked against [Workers runtime APIs](https://developers.cloudflare.com/workers/runtime-apis/). The differences below come from single-node topology and the pinned `workerd`. Cloudflare products that are not provided: [Unsupported](/docs/platform/unsupported/).

## Workers

| Topic                                                                                       | Behavior                                                                                              | Docs                                                                |
| ------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------- |
| Outbound `fetch` / sockets / `node:net`                                                     | Shared native workerd `Network(allow=["public"])`                                                     | [TCP sockets](/docs/workers/runtime-apis/tcp-sockets/)              |
...
| Request-scoped CPU / subrequest / simultaneous-connection quotas                            | The pinned workerd standalone process does not enforce them yet                                       | [Limits](/docs/platform/limits/)                                    |
| `LimitEnforcer` subrequest accounting                                                       | No-op; `getLimitsExceeded()` always reports none                                                      |                                                                     |
| Explicit Dynamic Worker `limits`                                                            | Rejected natively, including an empty object; default CPU/memory/subrequest enforcement belongs to W2 | [Bindings](/docs/workers/runtime-apis/bindings/)                    |
| Public-address boundary, product durable limits, handle cleanup, process supervision        | Still apply                                                                                           |                                                                     |
| Other numeric ceilings                                                                      | [Limits](/docs/platform/limits/)                                                                      |                                                                     |
| Deploy authority                                                                            | One local SQLite authority and one supervised runtime generation                                      | [Versions and deployments](/docs/workers/versions-and-deployments/) |
| Global rollout / placement / traffic splitting / account management / billing control plane | Not provided                                                                                          |                                                                     |
| Static Assets                                                                               | Immutable deployment content on the selected Local/S3 authority; routing and bindings covered         | [Static Assets](/docs/workers/static-assets/)                       |
| Global CDN placement / replication / purge propagation / product quotas                     | Not provided                                                                                          |                                                                     |
| Service Bindings                                                                            | Default / named fetch and RPC within one platform authority                                           | [Bindings](/docs/workers/runtime-apis/bindings/)                    |
...
| Topic                                                      | Behavior                                                                             | Docs            |
| ---------------------------------------------------------- | ------------------------------------------------------------------------------------ | --------------- |
| KV topology                                                | Single-node SQLite authority; no global replication or edge-cache propagation timing | [KV](/docs/kv/) |
| R2                                                         | Object bytes held by the selected single-node Local or S3-compatible authority       | [R2](/docs/r2/) |
| R2 global placement / replication                          | Not provided                                                                         |                 |
| D1 topology                                                | Single local-primary SQLite authority                                                | [D1](/docs/d1/) |
...
| Workflows execution                                                             | Local SQLite authority                                                                                    | [Workflows](/docs/workflows/)             |
...
| Topic                                                                                 | Behavior                                                             | Docs                                                                                  |
| ------------------------------------------------------------------------------------- | -------------------------------------------------------------------- | ------------------------------------------------------------------------------------- |
| Cache authority                                                                       | Workers Cache and Cache API are single-node local authority          | [Workers Cache](/docs/workers/cache/), [Cache API](/docs/workers/runtime-apis/cache/) |
