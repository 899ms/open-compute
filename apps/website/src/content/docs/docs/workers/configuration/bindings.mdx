...
<Tabs syncKey="package-manager">
  <TabItem label="npm">
    <Code code="npm exec -- wrangler types --config wrangler.jsonc" lang="sh" />
  </TabItem>
  <TabItem label="pnpm">
    <Code code="pnpm exec wrangler types --config wrangler.jsonc" lang="sh" />
  </TabItem>
  <TabItem label="bun">
    <Code code="bun run wrangler types --config wrangler.jsonc" lang="sh" />
  </TabItem>
</Tabs>

Runtime detail: [Runtime APIs · bindings](/docs/workers/runtime-apis/bindings/).
