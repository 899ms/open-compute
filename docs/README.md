...
| [I81–94 Cloudflare API、SDK 与生命周期缺口收敛](i81-94-cloudflare-api-parity.md)   | planned：收敛 Artifacts SDK、Worker Loader/Assets 类型、R2 list、upload diagnostics/observability、D1 migration extension 与 Worker force-delete lifecycle；`#91` 保持 Service Binding transfer boundary |
