...
| [I42–67 GitHub open issues 剩余实施批次](i42-67-github-open-issues.md)             | P15/`#51`、W2/`#67` 已完成；本批次剩余 `#66`、`#61`、`#62`、`#42`、`#58`                                                                                                                                               |
| [P16 capability-scoped TypeScript SDK](p16-capability-scoped-typescript-sdk.md)    | 已实现：`packages/sdk` 生成只暴露 qualified Cloudflare subset 与 `client.openCompute` 的 `@open-compute/sdk`；upstream refresh workflow 已接线；首次联合 release 待外部授权的 npm bootstrap                            |
